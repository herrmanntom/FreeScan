...
#pragma once
#endif // _MSC_VER > 1000
// GM1992PontiacProtocol.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CGM1992PontiacProtocol window
...
class CGM1992PontiacProtocol : public CGM1992PontiacParser
{
// Construction
public:
...
// Overrides
	...
	//{{AFX_VIRTUAL(CGM1992PontiacProtocol)
	public:
...
// Implementation
public:
	HWND Init(CSupervisor* pSupervisor, CSerialPort* pcom, CWnd* pParentWnd, CStatusDlg* pStatusDlg);// Initialises GM1992PontiacProtocol
