...
class CGMA160Protocol : public CBaseProtocol
{
// Construction
public:
	CGMA160Protocol(CStatusWriter* pStatusWriter, CSupervisorInterface* pSupervisor, BOOL bInteract);
	virtual ~CGMA160Protocol();

private:
	CGMA160Parser	m_parser;
