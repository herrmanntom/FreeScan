...
class CGMA143Protocol : public CBaseProtocol
{
// Construction
public:
	CGMA143Protocol(CStatusWriter* pStatusWriter, CSupervisorInterface* pSupervisor, BOOL bInteract);
	virtual ~CGMA143Protocol();

private:
	CGMA143Parser	m_parser;
