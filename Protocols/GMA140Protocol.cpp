// GMA140Protocol.cpp : implementation file
//
//////////////////////////////////////////////////////////////////////
...
BOOL CGMA140Protocol::SendModeShutUp(void)
{ //0xf4 0x56 0x08 0xae
...
BOOL CGMA140Protocol::SetDesiredIdle(unsigned char DesIdle)
...
void CGMA140Protocol::SendNextCommand(void)
{
	if (!m_bModeDone)
	{
...
LONG CGMA140Protocol::OnCharReceived(WPARAM ch, LPARAM BytesRead)
{
	...
	for(uByteIndex = 0; uByteIndex < uBytesRead; uByteIndex++)
	{
		...
		if (m_bReadHeader)
		{
			...
			if (m_bFirstRead)
			{
				if ((ucRX != ECU_HEADER_GMA140) & (ucRX != ECU_CHATTER_HEADER_GMA140))
				{
			...
			{
				if((ucRX != ECU_HEADER_GMA140) & (ucRX != ECU_CHATTER_HEADER_GMA140) & (ucRX != 0x90) & (ucRX != 0x0a))
...
int CGMA140Protocol::HandleTX(unsigned char* buffer, int iLength)
{
...
void CGMA140Protocol::OnIdle(void)
{
	if (!m_bInteract)
	{
...
void CGMA140Protocol::OnModeShutUp(void)
{
...
void CGMA140Protocol::OnModeDShutUp(void)
{
...
void CGMA140Protocol::OnMode1Msg0(void)
{
...
void CGMA140Protocol::OnModeD1Msg0(void)
{
...
void CGMA140Protocol::OnMode1Msg1(void)
{
...
void CGMA140Protocol::OnModeD1Msg1(void)
{
...
void CGMA140Protocol::OnMode1Msg2(void)
{
...
void CGMA140Protocol::OnModeD1Msg2(void)
{
...
void CGMA140Protocol::OnMode1Msg4(void)
{
...
void CGMA140Protocol::OnModeD1Msg4(void)
{
...
void CGMA140Protocol::OnMode1Msg6(void)
{
...
void CGMA140Protocol::OnModeD1Msg6(void)
{
...
void CGMA140Protocol::OnMode3(void)
{
...
void CGMA140Protocol::OnModeD3(void)
{
...
void CGMA140Protocol::OnMode4(void)
{
...
void CGMA140Protocol::OnModeD4(void)
{
...
void CGMA140Protocol::OnMode10(void)
{
