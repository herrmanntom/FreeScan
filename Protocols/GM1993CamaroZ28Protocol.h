...
class CGM1993CamaroZ28Protocol : public CBaseProtocol
{
// Construction
public:
	CGM1993CamaroZ28Protocol(CStatusWriter* pStatusWriter, CSupervisorInterface* pSupervisor, BOOL bInteract);
	virtual ~CGM1993CamaroZ28Protocol();

private:
	CGM1993CamaroZ28Parser	m_parser;
